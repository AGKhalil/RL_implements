...
def main(lr_ac=0.1321, lr_cr=0.08311):
    wandb.init(entity="agkhalil", project="pytorch-ac-mountaincarcont-bayesopt5", reinit=True)
    wandb.watch_called = False

    parser = argparse.ArgumentParser(description='PyTorch actor-critic example')
    parser.add_argument('--lr_ac', type=float, default=0.1321, metavar='lrac', help='actor learning rate')
    parser.add_argument('--lr_cr', type=float, default=0.08311, metavar='lrac',help='critic learning rate')
